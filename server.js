...
const mockEvents = {
    events: [
        { title: 'an event', id: 1, description: 'something really cool',location:'office',createddate:'2021-08-26' },
        { title: 'another event', id: 2, description: 'something even cooler',location:'college',createddate:'2021-08-26' }
    ]
};
