...
const mockEvents = {
    events: [
        { title: 'an event', id: 1, description: 'something really cool',location:'office',createddate:'8/26/2021' },
        { title: 'another event', id: 2, description: 'something even cooler',location:'college',createddate:'8/26/2021' }
    ]
};
